        ...
        <div className="flex-1 overflow-y-auto pr-2 space-y-5">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select
                value={theme}
                onChange={(e) => setSettings({ theme: e.target.value as 'light' | 'dark' | 'neon-cyber' | 'pastel-macaron' | 'sunset-horizon' })}
              ...
              >
                ...
                <option value="neon-cyber">赛博霓虹 (Neon Cyber)</option>
                <option value="pastel-macaron">马卡龙色 (Pastel Macaron)</option>
                <option value="sunset-horizon">日落霞光 (Sunset Horizon)</option>
              </select>
            </div>
          </div>
