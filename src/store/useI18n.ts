...
const en = {
  ...
  settings: {
    ...
    deepseekDefault: "DeepSeek (Default)",
    doubaoDefault: "Doubao (Default)",
    glmDefault: "GLM (Default)",
    apiKey: "API Key",
...
const zh = {
  ...
  settings: {
    ...
    modelConfig: "大模型配置",
    customModel: "自定义 (其他)",
    deepseekDefault: "DeepSeek (默认配置)",
    doubaoDefault: "豆包 Doubao (默认配置)",
    glmDefault: "智谱 GLM (默认配置)",
    apiKey: "API Key",
